...
const handleBackStep = () =>{
  ...
  React.useEffect(() => {
    ...
    handleNameChange();
    console.log(state.BestProtagonist)
  }, [Character])
      ...
      <C.ListBox>
        ...
        <div>
          ...
          {listCharacters.map((element, index)=>(
                ...
                <C.CharacterPost src={element.poster} key={index} onClick={()=> select(element)} className={state.BestProtagonist.name === element.name ?  'selected': ''}  />
